...
import com.bingo.manage.common.persistence.dao.DictMapper;
import com.bingo.manage.common.persistence.model.Dict;
import com.bingo.manage.core.log.LogObjectHolder;
import com.bingo.manage.core.util.ToolUtil;
import com.bingo.manage.modular.system.service.IDictService;
import com.bingo.manage.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = com.bingo.manage.common.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = com.bingo.manage.common.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = com.bingo.manage.common.constant.Dict.DeleteDict)
