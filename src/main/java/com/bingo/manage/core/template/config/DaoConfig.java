...
public class DaoConfig {
    ...
    public void init() {
        this.daoPathTemplate = "\\src\\main\\java\\com\\stylefeng\\manage\\modular\\" + contextConfig.getModuleName() + "\\dao\\{}Dao.java";
        this.xmlPathTemplate = "\\src\\main\\java\\com\\stylefeng\\manage\\modular\\" + contextConfig.getModuleName() + "\\dao\\mapping\\{}Dao.xml";
        this.packageName = "com.bingo.manage.modular." + contextConfig.getModuleName() + ".dao";
    }
