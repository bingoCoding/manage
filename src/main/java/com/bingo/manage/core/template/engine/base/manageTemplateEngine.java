package com.bingo.manage.core.template.engine.base;
 ...
 */
public abstract class manageTemplateEngine extends AbstractTemplateEngine {

    protected GroupTemplate groupTemplate;

    public manageTemplateEngine() {
        initBeetlEngine();
    }
