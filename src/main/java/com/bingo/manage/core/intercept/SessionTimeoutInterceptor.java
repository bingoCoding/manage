package com.bingo.manage.core.intercept;
...
@Aspect
@Component
@ConditionalOnProperty(prefix = "manage", name = "session-open", havingValue = "true")
public class SessionTimeoutInterceptor extends BaseController {

    @Pointcut("execution(* com.bingo.manage.*..controller.*.*(..))")
